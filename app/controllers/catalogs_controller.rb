class CatalogsController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to catalogs_path, status: :see_other, notice: "Catalog was successfully destroyed." }
  ...
  private
    ...
    def catalog_params
      params.expect(catalog: [ :name, :description, :visible, :user_id ])
    end
end
