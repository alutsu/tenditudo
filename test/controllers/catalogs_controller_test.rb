...
class CatalogsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create catalog" do
    assert_difference("Catalog.count") do
      post catalogs_url, params: { catalog: { description: @catalog.description, name: @catalog.name, user_id: @catalog.user_id, visible: @catalog.visible } }
    end
  ...
  test "should update catalog" do
    patch catalog_url(@catalog), params: { catalog: { description: @catalog.description, name: @catalog.name, user_id: @catalog.user_id, visible: @catalog.visible } }
